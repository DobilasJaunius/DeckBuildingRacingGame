...
void DepthBasedOutlines_float(float2 screenUV, float2 px, float stepVal, out float outlines){
    outlines = 0;
    ...
    outlines = step(stepVal, g);
    #endif
}

void NormalBasedOutlines_float(float2 screenUV, float2 px, float stepVal, out float outlines){
    outlines = 0;
